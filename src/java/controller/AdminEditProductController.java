...
/**
 ** The class contains method respond for initialize update new attribute get value form jsp insert to database. validate value after update. table in database. The method will throw an object of <code>java.lang.Exception</code> class if there is any error occurring when
 *
 * @author t.manh
 */
