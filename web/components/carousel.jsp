                    ...
                    <div class="outside-content">
                        <div class="inside-content">
                            <div class="container align-right">
                                ...
                                <h1 class="h3 colorful blue hidden-xs">Provide lightweight and powerful</h1>

                                <hr class="offset-sm">
                                <h2 class="h1 lg upp colorful blue">New amazing <br/> laptops</h2>
                                <hr class="offset-md">
                                <hr class="offset-md">
                                <a href="store?cid=1&sortid=0&page=1" rel="nofollow" class="btn btn-primary btn-lg black"> More laptops </a>
                    ...
                    <div class="outside-content">
                        <div class="inside-content">
                            <div class="container">
                                ...
                                <hr class="offset-md">
                                <hr class="offset-md">
                                <a href="store?cid=0&sortid=0&page=1" rel="nofollow" class="btn btn-primary btn-lg black"> View products </a>
