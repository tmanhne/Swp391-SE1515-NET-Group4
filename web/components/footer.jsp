            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="item">
                        ...
                        <h1>Low Price <br/> <span>Quality</span></h1>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3">
                    <div class="item">
            ...
            <div class="col-sm-3 col-md-2">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li><a href="#"> <img src="./assets/img/flags/gb.png" alt="Eng"/> English</a></li>
                        <li><a href="#"> <img src="./assets/img/flags/es.png" alt="Spa"/> Spanish</a></li>
                        <li><a href="#"> <img src="./assets/img/flags/de.png" alt="De"/> Deutch</a></li>
                        <li><a href="#"> <img src="./assets/img/flags/fr.png" alt="Fr"/> French</a></li>
                    </ul>
                </div>
                <hr class="offset-xs">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-3 align-right align-center-xs">
                ...
                <hr class="offset-sm">
                <p>Unistore Pro 2020 <br/> Designed By <a href="#">Nguyen Huy Hoang</a></p>
