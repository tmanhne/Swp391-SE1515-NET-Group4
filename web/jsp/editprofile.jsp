            ...
            <div class="row">
                <form action="editProfile" method="get">
                    <div class="row group">
                        ...
                        <div class="col-sm-8"> <input type="text" class="form-control" name="name" value="${sessionScope.account.name}" required="" placeholder=""/></div>
                    </div>

                    <div class="row group">
                        <div class="col-sm-4"><h2 class="h4">Phone</h2></div>
                        <div class="col-sm-8"> <input type="text" class="form-control" name="phone" value="${sessionScope.account.phone}" required="" placeholder=""/></div>
                    </div>

                    <div class="row group">
                        <div class="col-sm-4"><h2 class="h4">Address</h2></div>
                        <div class="col-sm-8"> <input type="text" class="form-control" name="address" value="${sessionScope.account.address}" required="" placeholder=""/></div>
                    </div>

                    <div class="row group">
                        <div class="col-sm-2 ml-10"> <input type="submit" class="form-control" value="Save"/></div>
                    </div>
                </form>
