                ...
                <div class="container dark-grey-text mt-5">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="p-4">
                            ...
                            <p class="lead font-weight-bold" style="font-size: 32px;">${book.getProductName()}</p>
                            <c:forEach items="${book.getAuthors()}" var="author" varStatus="loop">
                                <span style="font-size: 16px;" class="author">${author}</span>
                            </c:forEach>
                            <p style="font-size: 16px;" class="lead">
                                <span>Price: ${book.getUnitPrice()} ₫</span>
                            </p>
                            ...
                            <div class="be-comment-block">
                                ...
                                <form action="viewDetail" method="Post" class="form-block">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="id" value="${book.getProductID()}" />
                                        <input class="btn btn-primary pull-right" style="padding: 5px 10px; margin: 0 auto; font-size: 16px;" type="submit" value="Submit" name="btn-submit-comment" />
                                    </div>
                                </form>
                            </div>
                        </div> 
