                    ...
                    <form action="SignUpController" method="POST">
                         ...
                         <c:choose>
                                    <c:when test="${requestScope.user != null}">
                                        <input class="text" type="text" name="username" placeholder="Username" required="" value="${requestScope.user}">
                                        <input class="text email" type="text" name="email" placeholder="Email" required="" value="${requestScope.email}">
                                        <input class="text" type="text" name="phone" placeholder="Phone" required="" value="${requestScope.phone}"><br/>
                                        <input class="text" type="password" name="password" placeholder="Password" required=""  value="${requestScope.pass}">
                                        <input class="text w3lpass" type="password" name="cfPassword" placeholder="Confirm Password" required="" value="${requestScope.cfpass}">
                                    ...
                                    <c:when test="${requestScope.phone != null}">
                                        <input class="text" type="text" name="username" placeholder="Username" required=""value="${requestScope.user}">
                                        <input class="text email" type="text" name="email" placeholder="Email" required="" value="${requestScope.email}">
                                        <input class="text" type="text" name="phone" placeholder="Phone" required="" value="${requestScope.phone}"><br/>
                                        <input class="text" type="password" name="password" placeholder="Password" required="">
